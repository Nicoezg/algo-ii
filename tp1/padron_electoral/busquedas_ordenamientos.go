...
func Checkear_dni(dni int, err error) bool { //Checkea si el dni tiene un formato valido, si no lo tiene imprime un error y devuelve false
	if dni < 0 || err != nil {
